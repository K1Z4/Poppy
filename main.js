...
app.get('/', authenticate, (req, res) => res.render("index"));
app.post('/', authenticate, asyncMiddleware(require('./controllers/search-POST.js')))

app.get('/download/yt/:id', authenticate, asyncMiddleware(require('./controllers/download-youtube.js')))
app.post('/download/yt/:id', authenticate, asyncMiddleware(require('./controllers/download-youtube-POST.js')))
//app.get('/download/sc/:id', authenticate, asyncMiddleware(require('./controllers/download-soundcloud.js')))
